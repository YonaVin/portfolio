const translations = {
    en: {
      ...
      skills_title: "Skills",
      skills_text: "🧠 Knowledge",
      skills1: "HTML5/CSS3/Flexbox/Grid",
      skills2: "JavaScript (ES6+",
      skills3: "Git & GitHub",
      skills4: "UI/UX principles",
      skills5: "Responsive Web Design",
      skills6: "Web Accessibility (a11y) Basics",
      skills7: "SEO Basics",
      skills8: "Basic knowledge of React",
      tools_text: "🛠 Tools",
      skills_text2: "✨ Soft Skills",
      skills_list1: "Teamwork & Communication",
      skills_list2: "Problem Solving",
      skills_list3: "Time management",
      skills_list4: "Adaptability",
      skills_list5: "Attention to Detail",
      skills_list6: "Empathy",
      skills_list7: "Creativity & Visual Thinking",
    ...
    ru: {
      ...
      skills2: "JavaScript (ES6+)",
      skills3: "Git & GitHub",
      skills4: "Принципы UI/UX",
      skills5: "Адаптивный веб-дизайн",
      skills6: "Основы веб-доступности (a11y)",
      skills7: "Основы SEO",
      skills8: "Базовые знания React",
      tools_text: "🛠 Инструменты",
      skills_text2: "✨ Soft Skills",
      skills_list1: "Командная работа и коммуникация",
      skills_list2: "Решение проблем",
      skills_list3: "Управление временем",
      skills_list4: "Адаптивность",
      skills_list5: "Внимание к деталям",
      skills_list6: "Эмпатия",
      skills_list7: "Креативность и визуальное мышление",
    ...
    ko: {
      ...
      skills4: "UI/UX 원칙",
      skills5: "반응형 웹 디자인",
      skills6: "웹 접근성 (a11y) 기초",
      skills7: "SEO 기초",
      skills8: "React 기초",
      tools_text: "🛠 도구",
      skills_text2: "✨ 소프트 스킬",
      skills_list1: "팀워크 및 커뮤니케이션",
      skills_list2: "문제 해결",
      skills_list3: "시간 관리",
      skills_list4: "적응력",
      skills_list5: "세심함",
      skills_list6: "공감 능력",
      skills_list7: "창의성 및 시각적 사고",
      projects_title: "프로젝트",
      view_more: "더 보기",
